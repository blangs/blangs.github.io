...
<span style="color:green"><I><b>(server.xml)서버의 인코딩처리</b></I></span>    
...
<span style="color:green"><I><b>방법3. STS의 톰캣 start 옵션에 지정</b></I></span>    


 
### STEP2. web어플리케이션 인코딩을 변경  

<span style="color:green"><I><b>(web.xml)자바어플리케이션의 인코딩처리 지정</b></I></span>    
