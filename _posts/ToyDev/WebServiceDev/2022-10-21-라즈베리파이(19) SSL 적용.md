  ...
  3. SSL설정파일 수정
    : 주석해제한 설정 파일 내용을 수정한다.
      ...
      <VirtualHost _default_:443>
          ...
          # SSLCertificateChainFile "/fswas/apache/httpd/httpd-2.4.541/conf/server-ca.crt"
      ...
      <VirtualHost _default_:443>
          ...
          SSLCertificateChainFile "/etc/letsencrypt/live/www.blang.co.kr/chain.pem"  #발급한 경로로 설정
