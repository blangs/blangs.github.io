...
```js
const app = require('./app.js');
const PORT = process.env.PORT || 3000;  //환경변수가 잡힌다!.
process.env.NODE_ENV = process.env.NODE_ENV || 'development';  //환경변수가 잡힌다!.

if (process.env.NODE_ENV == 'development') {
	console.log('dev 입니다.');
} else if (process.env.NODE_ENV == 'production') { 
	console.log('prod 입니다.');
} else {
	console.log('local 입니다.');
}
