...
<head>
	...
	<style>
		...
		#footer {
		    ...
		    clear: both;                  /* 좌우(float: left 또는 float: right)로 부유된 요소를 제거 : float 속성으로 정렬된 요소들 때문에 레이아웃이 깨질 수 있습니다. clear 속성은 이런 상황에서 다음 요소가 부유된 요소의 영향을 받지 않고 정상적으로 배치되도록 돕습니다.*/
		}
