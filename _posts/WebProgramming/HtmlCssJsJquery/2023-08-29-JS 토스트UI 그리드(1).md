...
### common.css
```css
.indexBody .yarn .slideTitleWrap .gridWrap .grid{height:fit-content;background:#FFFFFF;height:355px;}
.indexBody .yarn .slideTitleWrap .gridWrap .grid:first-child{flex:0.819;width:1331px;margin-left:190px;}
.indexBody .yarn .slideTitleWrap .gridWrap .grid:last-child{flex:0.181;width:150px;margin-left:20px;margin-right:20px;}

.indexBody .yarn .slideMenuWrap{display:flex;bottom:30px;}
