...
## 궁금한 점 : 명시하지 않으면 트랜잭션 사용 순위는?
찾아보니 방법은 2가지가 있다고 한다.

### 방법0. 명시적 지정이 없는 경우
> ❗<span style='color:green'>***만약 트랜잭션 매니저가 명시적으로 지정되지 않았고, @Primary 애노테이션도 사용하지 않았다면, 스프링은 트랜잭션 매니저 빈이 하나만 존재하는 경우 그 빈을 기본 트랜잭션 매니저로 사용합니다.***</span>  
>    
> ❗<span style='color:green'>***transactionManager가 기본 트랜잭션 매니저로 설정된다.***</span>  
