...
2. 메인어플리케이션.java 우클릭 > Run Configuration.. -Spring Boot App - Arguments 탭
    - Project 콤보박스: local
    - main Type 텍스트박스: start
    - Profile 콤보박스: -Dspring.profiles.active=local
