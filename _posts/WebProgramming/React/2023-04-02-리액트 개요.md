...
## 핵심 개념
### 리액트가 개발된 이유
JS의 getElementById 으로 DOM 조작하여 변경 대상을 찾고 조작하는 것은 간단하다. 하지만 어플리케이션 규모가 커지면 성능이 떨어질 수 있다. 
이때 페이스북이 다음 아이디어를 생각한다.  
  
<span style="color:blue"><b>`어떤 변화를 줄지 고민하는 것이 아닌 기존뷰를 날려버린다. 그리고 처음부터 랜더링한다.`</b></span>
=======
## 왜 리액트인가? 등장배경
1. 자바스크립트의 열광
...
>>>>>>> 3793d85ef8e050eb6228ef3a31d4ac167b34a023
