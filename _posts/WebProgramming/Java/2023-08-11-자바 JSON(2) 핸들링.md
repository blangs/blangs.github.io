...
if (documnet != null && !documnet.isEmpty()) {
  ...
  System.out.println(strMsg);System.out.println(iStatus);
...
> 💡 자동으로 데이터 타입 변환을 처리해주므로 별도의 형변환 작업을 수동으로 할 필요가 없는점이다.  
> > 아래 작업을 안해도 된다.  
...
> ❗<span style='color:green'><b><I>***장점***</I></b></span>  
>   
> ```java
> JSONArray jsonArray = new JSONArray(jsonString);
> ```
